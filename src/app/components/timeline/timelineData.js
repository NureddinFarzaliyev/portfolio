export const timelineData = [
  ...
  },
  {
    ...
    content: (
      <div className='flex flex-col sm:flex-row gap-4'>
        <div className='shrink-0 w-[150px] md:w-[100px] lg:w-[150px] rounded-lg overflow-hidden'>
          <img src="/icons/webluna.png" className='w-[100%] rounded-lg' alt="unec" />
        </div>
        <p>👨‍💻 I've started to work as a Full-Stack (MERN-Stack) engineer at Webluna Software! Participating in real projects was a great chance for me to enhance my programming skills in a practical way.</p>
      </div>
    )
  },
  {
