...
export const Timeline = ({
  ...
  return (
    (<div
      className="w-full font-sans md:px-10 md:mt-[-100px]"
      ref={containerRef}>
        ...
        {data.map((item, index) => (
          <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
            <div
              ...
              <h3
                className="hidden md:block text-xl md:pl-14 md:text-5xl font-bold text-neutral-500 ">
                {item.title}
              </h3>
            </div>

            <div className="relative pl-20 pr-4 md:pl-4 w-full text-sm md:text-base">
              <h3
